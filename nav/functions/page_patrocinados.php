...
?>
				<li>
					...
					<h5><a href="<?php echo URL::getBase() ?>anuncio/<?php echo $urlAnuncio ?>" title="<?php echo $tituloAnuncio; ?>" class="adstitletop"><?php echo $tituloAnuncio ?></a></h5>
					<h5><a href="<?php echo URL::getBase() ?>anuncio/<?php echo $urlAnuncio ?>" title="<?php echo $tituloAnuncio; ?>" class="price"><?php echo $precoAnuncio ?></a></h5>
				</li>
	<?php
				$cont++;
			}
	...
	<?php
		...
		?>
                    <li class="span3">
	                    ...
	                    <span class="ads-desc-home text-left">
