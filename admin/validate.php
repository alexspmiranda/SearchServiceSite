...
$validator = strip_tags(trim($_GET['valmail']));
if(empty($validator)){
	$validator = 0;
	$validadorUser = 1;
}else{
	$validadorUser = sds_selectValidador($validator);
}
...
<header class="container-fluid header">
	<div class="container">
		<a href="<?php echo URL::getBase() ?>../index.php"><img src="<?php echo URL::getBase() ?>img/others/logo.png" alt="Logo do saldão de serviços" class="logo hidden-phone"></a>
		<a href="<?php echo URL::getBase() ?>../index.php"><img src="<?php echo URL::getBase() ?>img/others/logo_mobile.png" alt="Logo do saldão de serviços" class="logo logomobile visible-phone"></a>
	...
	if($validator == $validadorUser){	
		if(sds_validaCadastro($validadorUser)){
			echo '
				<span class="container-fluid validator text-center" style= "background:green; color:#fff;">
		...
		echo '
			<span class="container-fluid validator text-center" style= "background:red; color:#fff;">
				Não foi possível validar o cadastro!!!
			</span>
		';
	}
